...
# Caminho principal informado pelo usuário
BASE_DIR = Path(r"C:\Users\Wilson-pc\OneDrive\02. Meio Acadêmico_servicos\Kleiton - Teste\01. APP - Acessibilidade Documentos")
...
LOGO_PATH = Path("logo_construperj.png")
