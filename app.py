...
with tab_chat:
    ...
    # Compatibilidade: algumas versões do Streamlit Cloud ainda não possuem st.audio_input.
    if hasattr(st, "audio_input"):
        audio_pergunta = st.audio_input("Opcional: fale sua pergunta por voz")
    else:
        audio_pergunta = None
        st.caption("Entrada por voz indisponível nesta versão do Streamlit Cloud.")
